...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Gabriel Hernández Ontiveros"
  # spec.authors            = { "Gabriel Hernández Ontiveros" => "gabriel.h@skrumble.com" }
  # spec.social_media_url   = "https://twitter.com/Gabriel Hernández Ontiveros"
